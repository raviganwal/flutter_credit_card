              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    begin: Alignment(-1.04, -1.06),
                    end: Alignment(1.03, 1.0),
                    colors: [const Color(0xff9488e8), const Color(0xff140678)],
                    stops: [0.0, 1.0],
                  ),
...
class _GradientPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Path outerRectPath = Path()
      ..addRRect(outerRect);
    final Path innerRectPath2 = Path()
      ..addRRect(innerRect2);
    canvas.drawPath(
        Path.combine(
