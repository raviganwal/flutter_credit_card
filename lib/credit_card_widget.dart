...
class _CreditCardWidgetState extends State<CreditCardWidget>
  ...
  Widget _buildFrontContainer() {
    ...
    Theme
      ...
      const TextStyle(
        ...
        fontFamily: 'halter',
        fontSize: 16,
        package: 'flutter_credit_card_new',
      ),
    );
          ...
          Expanded(
            child: Padding(
              ...
              child: Text(
                ...
                style: widget.cardNumberTextStyle ?? defaultTextStyle,
              ),
            ),
          ),
          Expanded(
  ...
  Widget getCardTypeImage(CardType? cardType) {
    final List<CustomCardTypeIcon> customCardTypeIcon = getCustomCardTypeIcon(
        cardType!);
